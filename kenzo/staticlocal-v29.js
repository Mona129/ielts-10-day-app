...
(function(){
  ...
  const dock=document.createElement('button');dock.className='v29-dock';dock.innerHTML=`<b>${tr('参考案例','參考案例')}</b><span>${tr('像刷抖音一样，上下滑看 8 个完整视频 ›','像刷抖音一樣，上下滑看 8 支完整影片 ›')}</span>`;document.querySelector('.phone')?.appendChild(dock);
