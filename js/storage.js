...
function classify(t){const x=(t.module+' '+t.task).toLowerCase();if(x.includes('剑雅')||x.includes('真题'))return 'tests';if(t.module==='听力')return 'listening';if(t.module==='阅读')return 'reading';if(t.module==='口语')return 'speaking';if(t.module==='写作')return 'writing';if(t.module==='词汇')return 'vocab';if(t.module==='复盘')return 'review';return 'other'}
